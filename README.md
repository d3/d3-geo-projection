...
Note: projections tagged \[d3-geo\] are exported by [d3-geo](https://github.com/d3/d3-geo), not d3-geo-projection. These core projections are also included in the [d3](https://github.com/d3/d3) default bundle.
