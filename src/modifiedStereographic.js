...
import {abs, atan, atan2, cos, epsilon, sin, sqrt} from "./math";
...
export default function() {
  var m = projectionMutator(modifiedStereographicRaw),
      coefficients = modifiedStereographicCoefficients.miller,
      p = m(coefficients);
